...
- ✅ Phase 3：**数据扩充到 100+ 条**（当前 310 食材 / 225 目标 / 449 规则，两轮多代理起草+对抗式核验；覆盖烘焙/乳制品 + 坚果种子/生鲜香料/亚洲全球调料/蛋白豆类/调味品/饮品，含 AND 复合调料粉）
- ✅ **文献核查**：对高风险(复合 AND + 化学转化)规则用真实烹饪文献(King Arthur / Serious Eats / America's Test Kitchen / Harold McGee 《On Food and Cooking》 / BBC Good Food)核验，应用了 27 处外部条件/比例修正并删除 1 条误配规则(ground_ginger<=allspice+cinnamon，450→449)。典型条件：小苏打需配方含酸(非与泡打粉 1:1)、淀粉须冷水调浆、明胶↔琼脂非 1:1 且须煮沸、可可→巧克力需加脂、亚麻籽/苹果酱蛋仅作粘合(1–2 个蛋)、苏打水的碳酸不可用静水替代、鲜:干香草约 3:1
...
4. ~~**数据扩充到 100+ 条**：手工种子 + 挖掘。~~ ✅ 已完成（310 食材 / 225 目标 / 449 规则；两轮多代理起草 + 对抗式核验 + 文献核查 + 人工去噪，后续可继续从 Food.com 评论 / Recipe1MSubs 扩充）。
